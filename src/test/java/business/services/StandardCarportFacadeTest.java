...
class StandardCarportFacadeTest {
    ...
    private static StandardCarportFacade standardCarportFacade;
    ...
    void insertStandardCarport() throws UserException {
        ...
        TreeMap<Integer, Carport> standardCarports = standardCarportFacade.getStandardCarports();
